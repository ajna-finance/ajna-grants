...
import { ExtraordinaryFunding } from "./grants/ExtraordinaryFunding.sol";
import { StandardFunding } from "./grants/StandardFunding.sol";
import { IGrantFund } from "../../../src/grants/interfaces/IGrantFund.sol";

contract TestGrantFund is IGrantFund, ExtraordinaryFunding, StandardFunding {

    using SafeERC20 for IERC20;

    constructor(address ajnaToken_)  {
        ajnaTokenAddress = address(ajnaToken_);
    }
