...
contract UpgradeableTokenTest is Test {
    ...
    function testTokenTotalSupply() external {
        assertEq(_tokenProxyV1.totalSupply(), 1_000_000_000 * 1e18);
    }
    ...
    function testMinterTokenBalance() external {
        assertEq(_tokenProxyV1.balanceOf(address(this)), 1_000_000_000 * 1e18);
    }
    ...
    function testBurn() external {
        ...
        assertEq(_tokenProxyV1.totalSupply(), 950_000_000 * 1e18);
    }

    function testTransferWithApprove(uint256 amount_) external {
        vm.assume(amount_ > 0);
        vm.assume(amount_ <= 1_000_000_000 * 1e18);
        ...
        assertEq(_tokenProxyV1.balanceOf(address(this)),  1_000_000_000 * 1e18 - amount_);
    ...
    function testTransferWithPermit(uint256 amount_) external {
        ...
        vm.prank(spender);
        _tokenProxyV1.transferFromWithPermit(owner, newOwner, spender, amount_, permit.deadline, v, r, s);
    ...
    function testDelegateVotes() external {
        ...
        deal(address(_tokenProxyV1), delegator, 1_000 * 1e18);
        ...
        assertEq(_tokenProxyV1.balanceOf(delegator), 1_000 * 1e18);
        assertEq(_tokenProxyV1.balanceOf(delegate1), 0);
        assertEq(_tokenProxyV1.balanceOf(delegate2), 0);
        // check voting power
        assertEq(_tokenProxyV1.getVotes(delegator), 0);
        assertEq(_tokenProxyV1.getVotes(delegate1), 1_000 * 1e18);
        assertEq(_tokenProxyV1.getVotes(delegate2), 0);
    ...
    function testCalculateVotingPower() external {
        ...
        deal(address(_tokenProxyV1), delegator1, 1_000 * 1e18);
        deal(address(_tokenProxyV1), delegator2, 2_000 * 1e18);
        deal(address(_tokenProxyV1), delegate1,  3_000 * 1e18);
        deal(address(_tokenProxyV1), delegate2,  4_000 * 1e18);
        ...
        assertEq(_tokenProxyV1.getVotes(delegator1), 0);
        assertEq(_tokenProxyV1.getVotes(delegator2), 0);
        assertEq(_tokenProxyV1.getVotes(delegate1),  3_000 * 1e18);
        assertEq(_tokenProxyV1.getVotes(delegate2),  4_000 * 1e18);
        ...
        assertEq(_tokenProxyV1.getVotes(delegator1), 0);
        assertEq(_tokenProxyV1.getVotes(delegator2), 0);
        assertEq(_tokenProxyV1.getVotes(delegate1),  4_000 * 1e18);
        assertEq(_tokenProxyV1.getVotes(delegate2),  6_000 * 1e18);
    ...
    function testNestedDelegation() external {
        ...
        assertEq(_tokenProxyV1.getVotes(address(this)), 0);
        assertEq(_tokenProxyV1.getVotes(address(3333)), 1_000_000_000 * 1e18);
        assertEq(_tokenProxyV1.getVotes(address(4444)), 0);
        ...
        assertEq(_tokenProxyV1.getVotes(address(this)), 0);
        assertEq(_tokenProxyV1.getVotes(address(3333)), 0);
        assertEq(_tokenProxyV1.getVotes(address(4444)), 1_000_000_000 * 1e18);
    }
